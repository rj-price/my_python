...
#Set chromosomes
AB_circle = Gcircle(figsize=(8,8)) 
with open("AB_names.csv") as f:
    f.readline()
    for line in f:
...
with open("Anitra_names.csv") as f:
    ...
    for line in f:
        ...
        AB_circle.add_garc(arc2)
        
AB_circle.set_garcs(0,360)
...
with open("AB_names.csv") as f:
    ...
    for line in f:
        ...
        name   = line[0]
        length = int(line[-1]) 
        AB_circle.tickplot(garc_id=name, tickinterval=5000000, tickwidth='2', raxis_range=(950, 965))
        AB_circle.tickplot(garc_id=name, tickinterval=1000000, raxis_range=(950, 965))
...
for key in arcdata_dict:  
    AB_circle.barplot(key, data=arcdata_dict[key]["values"], positions=arcdata_dict[key]["positions"], 
...
for key in genedata_dict:  
    AB_circle.barplot(key, data=genedata_dict[key]["values"], positions=genedata_dict[key]["positions"], 
...
with open("AB_satsuma.csv") as f:
    ...
    for line in f:
        ...
        AB_circle.chord_plot(source, destination, facecolor=AB_circle.garc_dict[name1].facecolor)

# Save output
AB_circle.save(file_name="AB_circos", format="jpg")
AB_circle.save(file_name="AB_circos", format="pdf")
